...
dt = 0.5;    
BCL = 800/dt;      
endpoint=800*a+600*b+536*b+430*b;
tstep1 = 800/dt;
tstep2 = 600/dt;
tstep3 = 536/dt;
cycle = 0;
...
for i=1:1:length(ts)-1
    ...
    if(i>1 && mod(t(i-1),BCL) == 0)
        ...
        Pper(cycle)= mean(PVQ(i-BCL/dt:1:i-1,3)-PVQ(i-BCL/dt:1:i-1,6));
...
results.perfusion = [Pper(9), Pper(28), Pper(48), Pper(end)];

save('baseline_reg.mat','PVQ')
